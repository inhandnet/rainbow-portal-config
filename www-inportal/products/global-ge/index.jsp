...
<script src="js/create_menu.js" type="text/javascript"></script>
	 ...
	 <tr>
	   <td height="100%" width="160px">
		      ...
		      <table border="0" cellpadding="0" cellspacing="0"  width="160px" height="100%">
				 ...
				 <tr>
				 	<!-- 左边区背景图片  -->
				   <td height="100%" width="100%"  align="left" valign="top"  style=" background-image:url(images/leftBgroud.gif)">
											   	  ...
											   	  <table border="0" cellpadding="0" cellspacing="0"  width="100%" height="100%">
											   	    ...
											   	    <tr>
											   	    	 ...
											   	    	 <td height="15%" width="100%" valign="top" align="center">
											   	    	 	<a href="#" style="text-decoration:underline;color:#003300;"><span style="font-size:12px; font-weight:bold;cursor:pointer" id="button_saveConfig" onclick="saveConfig();"></span></a>
											   	    	 </td>
											   	    </tr>
											   	    <!-- 版权信息 -->
											   	    <tr>
	   ...
	   <td height="100%">
				   ...
				   <table border="0" cellpadding="0" cellspacing="0"  width="100%" height="100%">
					 <tr>
						 <!-- 上边区背景图片  -->
					   <td height="75" width="100%"  valign="bottom"  style=" background-image:url(images/titleBgroud.gif)">
																							...
																							<tr>
																								<td height="22px" valign="bottom">
																										<table height="22px" cellspacing="0" cellpadding="0" border="0" style="display:none">
																											<tbody>
																												<tr>
																													<td width="5px" style="background-image: url(&quot;../images/lableBG05.png&quot;);"></td>
																													<td onclick="openExtraWindow('help')" style="background-image: url(&quot;../images/lableBG04.png&quot;); cursor: pointer;">
																														<span style="font-size: 12px; font-weight: bold; color: black;">/锟斤拷</span></td>
																													<td width="1px" style="background-color: rgb(51, 51, 51);"></td>
																												</tr>
																											</tbody>
																										</table>
																								</td>
																								<td height="22px" valign="bottom">
																										<table height="22px" cellspacing="0" cellpadding="0" border="0">
																											  <tbody>
																											  	<tr>
																											  		<td width="5px" style="background-image: url(&quot;../images/lableBG05.png&quot;);"></td>
																											  		<td onclick="openExtraWindow('trap')" style="background-image: url(&quot;../images/lableBG04.png&quot;); cursor: pointer;">
																											  			<span style="font-size: 12px; font-weight: bold; color: black;"><%get_text(ui.alarm)%></span></td>
																											  		<td width="1px" style="background-color: rgb(51, 51, 51);"></td>
																												</tr>
																											</tbody>
																										</table>
...
//////////////////////////////////////////////////////////////////	
	...
	function menuClick(obj)
	{
		...
		if(document.getElementById("Span_"+id+"_td"+id)!=null){
			...
			Spantd_Fid_Id.style.color="black";
		}
