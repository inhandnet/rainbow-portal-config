...
//	alert(f[cfg_idx].value);
	...
	if (f[cfg_idx].value == 0 ){//disable
		...
		f[txperiod_idx].disabled = false;
		f[quiet_period_idx].disabled = false;
		f[reauth_enabled_idx].disabled = false;
		f[reauth_period_idx].disabled = false;
		f[reauth_max_idx].disabled = false;
		f[supp_to_idx].disabled = false;
		f[svr_to_idx].disabled = false;		
	}
