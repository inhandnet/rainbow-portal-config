(function($){
    $.validationEngineLanguage = {
        en:{
            "rainbowip":{
                "regex":/^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5]))$|^(([a-zA-Z0-9]+\.?[a-zA-Z0-9]+)+)$/i,
                "alertText":"*Incorrect address format"
            },
            "rainbowport":{
                "regex":/^([1-9]?)|([1-9]\d)|([1-9]\d{2})|([1-9]\d{3})|([1-5]\d{4})|(6[0-5]{2}[0-3][0-5])$/,
                "alertText":"*Port incorrect format"
            },
        	"queryReport":{
    			"regex":"none",
...
//                	"alertText": "* Invalid mobile number"
                    "regex":/^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5]))$|^(([a-z]+\.?[a-z]+)+)$/i,
                    "alertText":"*Incorrect address format"
                },
                "email": {
			...
			"func": function (field) {
			 ...
			 "alertText": "* Invalid date: must be in YYYY-MM-DD format"
                ...
                "macMacth":{
                    "regex":/[A-Fa-f0-9]{2,2}:[A-Fa-f0-9]{2,2}:[A-Fa-f0-9]{2,2}:[A-Fa-f0-9]{2,2}:[A-Fa-f0-9]{2,2}:[A-Fa-f0-9]{2,2}/,
